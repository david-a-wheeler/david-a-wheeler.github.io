...
;;===========================================================================
;; File:         machine.lisp
;; Author:       Wolfgang Goerigk and David A. Wheeler
;; Content:      ACL2 implementation of a simple abstract machine (modified)
;;               Originally by Wolfgang Goerigk; modified by DAW to
;;               run in straight Common Lisp.
;;===========================================================================
...
;; Function named "execute" conflicts with clisp's "execute", so renamed
;; to "execute-am" (execute abstract machine).

(defun execute-am (prog stack n)
