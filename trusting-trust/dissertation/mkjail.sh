...
# NOTE: Install "busybox" before using this.
...
# Disable stripping files - we WANT all the symbols!
...
#
# Note: With bash, would have to do more, e.g.:
# libtinfo
# Note: Some of the below are needed for Debian, not for Fedora.
for lib in \
 ...
 libssp libmudflap libtinfo libselinux libacl libsepol libattr
 do
